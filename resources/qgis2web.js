...
map.getView().fit([13236852.033439, -1232973.188405, 13937850.281286, -866460.590312], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Analisis Spasial </h2>';
        return titleElement;
    })(),
